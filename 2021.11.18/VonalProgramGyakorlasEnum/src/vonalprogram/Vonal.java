...
public class Vonal {
    ...
    public Vonal(int hossz, int kezdX) {
        //this.hossz = hossz;
        //this.kezdX = kezdX;
        this(hossz, kezdX, Tipusok.NORMAL);  //ez hívja a 3 paraméterest
        //this(hossz, kezdX, "normál", "fekete");
    }

    public Vonal(int hossz, int kezdX, Tipusok tipus) {
        //this.hossz = hossz;
        //this.kezdX = kezdX;
        //this.tipus = tipus;
    ...
    public Vonal(int hossz, int kezdX, Tipusok tipus, String szin) {
        if (hossz < 1) {
            hossz = 1;
        }
        this.hossz = hossz;
